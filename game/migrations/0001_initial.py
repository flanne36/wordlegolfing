# Generated by Django 4.1 on 2022-10-13 16:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guess1', models.CharField(blank=True, default='', max_length=5)),
                ('guess2', models.CharField(blank=True, default='', max_length=5)),
                ('guess3', models.CharField(blank=True, default='', max_length=5)),
                ('guess4', models.CharField(blank=True, default='', max_length=5)),
                ('guess5', models.CharField(blank=True, default='', max_length=5)),
                ('guess6', models.CharField(blank=True, default='', max_length=5)),
